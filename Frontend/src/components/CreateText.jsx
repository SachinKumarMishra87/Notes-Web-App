...
const CreateText = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/create-note`, formData, {
        headers: {
  ...
  return (
    <div className="h-screen w-full bg-black/90 flex justify-center items-center text-white">
      <div className="relative bg-white/10 backdrop-blur-md p-8 rounded-2xl shadow-lg w-[90%] sm:w-[400px] text-white">
        ...
        {/* Heading */}
        <h2 className="text-2xl font-bold text-center mb-6">Create a New Note</h2>
